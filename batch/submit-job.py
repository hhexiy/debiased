...
batch = boto3.client(
    service_name='batch',
    region_name=region,
    endpoint_url='https://batch.{}.amazonaws.com'.format(region))

cloudwatch = boto3.client(
    service_name='logs',
    region_name=region,
    endpoint_url='https://logs.{}.amazonaws.com'.format(region))
...
parser.add_argument("--mem", type=int, default=200, help="memory resource in MB")
